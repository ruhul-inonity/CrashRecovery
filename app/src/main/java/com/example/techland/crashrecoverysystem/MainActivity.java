...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_crash_main_thread = findViewById(R.id.button_crash_main_thread);
     ...
     //   app = (CrashRecoveryApplication) getApplication();

        button_crash_main_thread.setOnClickListener(new View.OnClickListener() {
            @Override
